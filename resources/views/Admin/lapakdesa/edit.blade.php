                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form class="needs-validation" novalidate action="/admin/lapakdesa/{{ $lapakdesa->id }}"
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_produk"
                                                    ...
                                                    value="{{ old('nama_produk', $lapakdesa->nama_produk) }}" required>
                                                @error('nama_produk')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="harga"
                                                    ...
                                                    placeholder="Harga" value="{{ old('harga', $lapakdesa->harga) }}"
                                                    required>
                                                @error('harga')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi"
                                                    placeholder="Deskripsi" rows="4" required>{{ old('deskripsi', $lapakdesa->deskripsi) }}</textarea>
                                                @error('deskripsi')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mitra"
                                                    ...
                                                    placeholder="Mitra" value="{{ old('mitra', $lapakdesa->mitra) }}"
                                                    required>
                                                @error('mitra')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="link_wa"
                                                    ...
                                                    id="link_wa" placeholder="Link WA"
                                                    value="{{ old('link_wa', $lapakdesa->link_wa) }}" required>
                                                @error('link_wa')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="link_maps"
                                                    ...
                                                    id="link_maps" placeholder="Link Maps"
                                                    value="{{ old('link_maps', $lapakdesa->link_maps) }}" required>
                                                @error('link_maps')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        @if ($lapakdesa->image)
                                            <img src="{{ asset($lapakdesa->image) }}" alt="Current Image" class="mt-2"
