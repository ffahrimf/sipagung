                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="text-right">
                                    <a href="/mkis" class="btn btn-warning btn-sm"><i
                                            class="fa-solid fa-arrow-rotate-left"></i>
                                        Back
                                    </a>
                                </div>
                            </div>
                            <form class="needs-validation" novalidate action="/mkis" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="jenis"
                                                    ...
                                                    placeholder="Jenis Jaminan" value="{{ old('jenis') }}"
                                                    required>
                                                @error('jenis')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select name="kategori"
                                                    ...
                                                    <option value="PBI"
                                                        {{ old('kategori') == 'PBI' ? 'selected' : '' }}>PBI</option>
                                                    <option value="Non PBI"
                                                        {{ old('kategori') == 'Non PBI' ? 'selected' : '' }}>Non PBI</option>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan"
                                                    placeholder="Keterangan" rows="2" required>{{ old('keterangan') }}</textarea>
                                                @error('keterangan')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
