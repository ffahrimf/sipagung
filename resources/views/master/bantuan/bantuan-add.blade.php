                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="text-right">
                                    <a href="/mbantuan" class="btn btn-warning btn-sm"><i
                                            class="fa-solid fa-arrow-rotate-left"></i>
                                        Back
                                    </a>
                                </div>
                            </div>
                            <form class="needs-validation" novalidate action="/mbantuan" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="jenis"
                                                    ...
                                                    placeholder="Bantuan Sosial" value="{{ old('jenis') }}"
                                                    required>
                                                @error('jenis')
